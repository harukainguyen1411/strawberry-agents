...
orianna_signature_in_progress: "sha256:2e8dec96fa79a1facc6ac550592787027f15f72e463ba5a0f20281978c42f1cb:2026-04-22T14:31:21Z"
orianna_signature_implemented: "sha256:2e8dec96fa79a1facc6ac550592787027f15f72e463ba5a0f20281978c42f1cb:2026-04-22T14:33:02Z"
---
...
2. `.git/COMMIT_SCOPE` file — same format. Cleared (`rm -f`) by the hook on successful scope match, so stale scope cannot leak into the next commit. <!-- orianna: ok -- git internal path, not a repo file -->
...
- Shared-rules `_shared/` updates standardizing a commit preamble with scope declaration. Follow-up. <!-- orianna: ok -- hypothetical shared dir, no actual path -->
...
- **I5 — `.git/COMMIT_SCOPE` is cleared on successful match.** Prevents stale scope leaking into the next commit. Covered by Task 1 Case E. <!-- orianna: ok -- git internal path, not a repo file -->
...
None. This plan adds a new pre-commit hook script and a test script. No existing architecture docs or system contracts are modified.
