...
Workspace repos (`~/Documents/Work/mmp/workspace/`, `~/Documents/Personal/strawberry-app/`, etc.) hold code. This repo holds plans, architecture, and memory. Plan promotions are handled by the **Orianna agent** — see `architecture/agent-network-v1/plan-lifecycle.md`. You amend plans inline; you do not create new plans.
