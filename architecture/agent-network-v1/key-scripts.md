...
Reference table for operational scripts. See `architecture/agent-network-v1/platform-parity.md` for platform coverage.
...
See `architecture/agent-network-v1/plan-lifecycle.md` for the full promotion flow.
...
- Full platform matrix: `architecture/agent-network-v1/platform-parity.md`.
