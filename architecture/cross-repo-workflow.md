...
and (b) one approving review from an account other than the PR author.
An agent may merge its own PR once (a) and (b) are satisfied. `harukainguyen1411` has admin bypass
