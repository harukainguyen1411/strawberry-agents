...
- 2026-04-20 (T1.3 plan-frontmatter doc): Created architecture/plan-frontmatter.md (978 words, 199 lines) (legacy path; current canonical: architecture/agent-network-v1/plan-frontmatter.md). Committed direct to main at 75b4fa5.
