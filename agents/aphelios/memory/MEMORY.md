...
- `architecture/cross-repo-workflow.md` (legacy path; current canonical: architecture/agent-network-v1/cross-repo.md) — canonical copy in strawberry-agents (three-repo version); may supersede a two-repo draft Kayn's P5.3 puts on strawberry first.
