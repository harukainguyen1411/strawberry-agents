...
- Firebase preview secret: `FIREBASE_SERVICE_ACCOUNT` is EMPTY. `FIREBASE_SERVICE_ACCOUNT_MYAPPS_B31EA` is the populated one (auto-generated by Firebase Console). PR #56 updates both preview workflows to reference the correct secret.
