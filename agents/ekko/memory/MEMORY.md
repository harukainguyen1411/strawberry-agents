...
- 2026-04-19 (s9): added TDD-Waiver empty commit (9666ace) to PR #25 — xfail-first check now passes.
...
- 2026-04-19 (s14): opened PR #54 — two CI fixes: release.yml detached-HEAD + preview.yml turbo --force cache bust
- 2026-04-19 (s16): fixed tdd-gate push-event range bug — replaced GH_BEFORE with git merge-base. PR #55 opened.
- 2026-04-19 (s17): fixed firebase preview secret wiring. PR #56 opened.
- 2026-04-19 (s18): amended PR #56 — canonical FIREBASE_SERVICE_ACCOUNT secret. Pushed.
- 2026-04-19 (s19): added TDD-Waiver empty commit (074e750) to PR #33 (V0.3 firestore-schema). All CI checks green.
- 2026-04-19 (ekko s2): PR #32 V0.2 + PR #43 V0.9 — merged origin/main, resolved conflicts. Both pushed.
- 2026-04-19 (ekko retry): PR #44 V0.10 — merged origin/main, resolved firestore.rules.test.ts conflict. Pushed.
...
- 2026-04-19 (ekko s25): merged PR #42 (V0.8 importCsv handler) via reviewer-auth.sh as strawberry-reviewers. Merge SHA: 73b9e2a. Branch deleted.
